...
fp3 = ax1.plot(ffp3["xr"][end-2] .+ fluxloc_final[3, 2], ffp3["yr"][end-2] .+ fluxloc_final[3, 1], color=ctab10(2), label = "T2IRG (60%)")
fp4 = ax1.plot(ffp4["xr"][end-2] .+ fluxloc_final[4, 2], ffp4["yr"][end-2] .+ fluxloc_final[4, 1], color=ctab10(3), label = "T2CSAT (60%)")
