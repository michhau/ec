...
#y-axis limits
wT_limits = (-15, 35)
wq_limits = (-1, 20)#wT_limits

# Upper subplot - Buoyancy fluxes (sensible heat)
ax1.set_title("2b Turbulent Heat Fluxes")
...
labels = ["pond 1.1m", "pond 2.2m", "ice 1.2m", "ice 2.2m"]
...
PyPlot.savefig(joinpath(output_folder, "2b.pdf"), bbox_inches="tight")
######################################################
##
