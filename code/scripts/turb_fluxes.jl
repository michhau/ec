...
labels = ["ice 1.1m", "ice 2.1m", "lead 1.3m", "lead 2.3m"]
...
ax5.hist(ratio2, bins=collect(-1.0:0.01:3.0), color="blue", alpha=0.7, density=true)#, edgecolor="white", linewidth=0.3)
...
ax6.hist(ratio3, bins=collect(-1.0:0.01:3.0), color="black", alpha=0.7, density=true)#, edgecolor="white", linewidth=0.3)
