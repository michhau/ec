...
ax4.hist(scatter1a, bins=collect(-5:0.1:10), color="grey", alpha=0.5, density=true, label="ice")
ax4.hist(scatter1b, bins=collect(-5:0.1:10), color="orange", alpha=0.5, density=true, label="pond")
...
ax5.hist(scatter2a, bins=collect(0:0.1:7), color="grey", alpha=0.5, density=true, label="ice")
ax5.hist(scatter2b, bins=collect(0:0.1:7), color="orange", alpha=0.5, density=true, label="pond")
ax5.set_xlabel(L"\overline{w'q'}~\mathrm{[W~m^{-2}]}")
ax5.legend()
ax5.grid(alpha=0.3)

ax6 = fig.add_subplot(gs[2, 3])
ax6.hist(scatter3a, bins=collect(-10:0.1:10), color="grey", alpha=0.5, density=true, label="ice")
ax6.hist(scatter3b, bins=collect(-10:0.1:10), color="orange", alpha=0.5, density=true, label="pond")
