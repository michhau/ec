...
fig_ht.suptitle("1b-1 - Sensible Heat Flux Height Comparison")
...
ax_ht6.hist(ratio_ht2, bins=collect(-5.0:0.01:5.0), color="black", alpha=0.7, density=true)
...
#PyPlot.savefig(joinpath(output_folder_ht, "1b1_per_tower.pdf"), bbox_inches="tight")
