...
ax4.hist(ratio1, bins=collect(-1.0:0.01:3.0), color="black", alpha=0.7, density=true)#, edgecolor="white", linewidth=0.3)
...
ax5.hist(ratio2, bins=collect(0:0.01:2.0), color="blue", alpha=0.7, density=true)#, edgecolor="white", linewidth=0.3)
