...
fig_mom.suptitle("1a - Friction Velocity")
...
ax_m1.scatter_density(scatter_mom1a, scatter_mom1b, color="red", vmin=0, vmax=2000)
...
ax_m2.scatter_density(scatter_mom2a, scatter_mom2b, color="red", vmin=0, vmax=2000)
...
ax_m3.scatter_density(scatter_mom3a, scatter_mom3b, color="red", vmin=0, vmax=2000)
...
ax_m4.scatter_density(scatter_mom4a, scatter_mom4b, color="red", vmin=0, vmax=2000)
...
ax_m11.hist(ratio_mom3, bins=collect(0.9:0.001:1.2), color="red", alpha=0.7, density=true)
...
#PyPlot.savefig(joinpath(output_folder_mom, "1a.pdf"), bbox_inches="tight")
