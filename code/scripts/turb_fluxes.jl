...
fig_ht.suptitle("1b-2 - Sensible Heat Flux Height Comparison")
...
ax_ht1.scatter_density(scatter1, scatter2, color="black", vmin=0, vmax=1000)
lim_ht1 = (-25, 15)
...
ax_ht2.scatter_density(scatter3, scatter4, color="black", vmin=0, vmax=1000)
lim_ht2 = (-20, 15)
...
#PyPlot.savefig(joinpath(output_folder_ht, "1b2_per_tower.pdf"), bbox_inches="tight")
