...
#y-axis limits
wT_limits = (-30, 30)
wq_limits = (-15, 10)#wT_limits

# Upper subplot - Buoyancy fluxes (sensible heat)
ax1.set_title("2a Turbulent Heat Fluxes")
...
#PyPlot.savefig(joinpath(output_folder_wT, "2a.pdf"), bbox_inches="tight")
##
...
#PyPlot.savefig(joinpath(output_folder_uw, "2a.pdf"), bbox_inches="tight")
##
##########################################################
#=
##
...
var3a = fx2
var3b = fx4
sc_lbl_idx = [1, 3, 2, 4] #indexing for labels
...
ax1.scatter_density(scatter1a, scatter1b, color="black", vmin=00, vmax=2500)
lim_1 = (-25, 15)
ax1.set_xlim(lim_1)
ax1.set_ylim(lim_1)
...
fig_mom.suptitle("2a - Friction Velocity")
...
ax_m1.scatter_density(scatter_mom1a, scatter_mom1b, color="red", vmin=0, vmax=1500)
...
ax_m2.scatter_density(scatter_mom2a, scatter_mom2b, color="red", vmin=0, vmax=1500)
...
ax_m3.scatter_density(scatter_mom3a, scatter_mom3b, color="red", vmin=0, vmax=1500)
...
ax_m4.scatter_density(scatter_mom4a, scatter_mom4b, color="red", vmin=0, vmax=1500)
...
ax_m5.hist(scatter_mom1a, bins=100, color="grey", alpha=0.5, density=true, label=instr_labels[sc_lbl_idx[1]])
ax_m5.hist(scatter_mom1b, bins=100, color="orange", alpha=0.5, density=true, label=instr_labels[sc_lbl_idx[2]])
...
ax_m6.hist(scatter_mom2a, bins=100, color="grey", alpha=0.5, density=true, label=instr_labels[sc_lbl_idx[3]])
ax_m6.hist(scatter_mom2b, bins=100, color="orange", alpha=0.5, density=true, label=instr_labels[sc_lbl_idx[4]])
...
ax_m7.hist(scatter_mom3a, bins=100, color="grey", alpha=0.5, density=true, label=instr_labels[1])
ax_m7.hist(scatter_mom3b, bins=100, color="orange", alpha=0.5, density=true, label=instr_labels[2])
...
ax_m8.hist(scatter_mom4a, bins=100, color="grey", alpha=0.5, density=true, label=instr_labels[3])
ax_m8.hist(scatter_mom4b, bins=100, color="orange", alpha=0.5, density=true, label=instr_labels[4])
...
ax_m9.hist(ratio_mom1, bins=collect(0.5:0.001:1.3), color="red", alpha=0.7, density=true)
...
ax_m10.hist(ratio_mom2, bins=collect(0.7:0.001:1.3), color="red", alpha=0.7, density=true)
...
ax_m11.hist(ratio_mom3, bins=collect(0.7:0.001:1.2), color="red", alpha=0.7, density=true)
...
ax_m12.hist(ratio_mom4, bins=collect(0.8:0.001:1.3), color="red", alpha=0.7, density=true)
...
#PyPlot.savefig(joinpath(output_folder_mom, "2a.pdf"), bbox_inches="tight")
