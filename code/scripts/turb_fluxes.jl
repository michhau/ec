...
ax5.hist(scatter2a, bins=collect(-15:0.1:10), color="grey", alpha=0.5, density=true, label=instr_labels[sc_lbl_idx[1]])
ax5.hist(scatter2b, bins=collect(-15:0.1:10), color="orange", alpha=0.5, density=true, label=instr_labels[sc_lbl_idx[2]])
...
ax6.hist(scatter3a, bins=collect(-60:0.1:40), color="grey", alpha=0.5, density=true, label=instr_labels[sc_lbl_idx[3]])
ax6.hist(scatter3b, bins=collect(-60:0.1:40), color="orange", alpha=0.5, density=true, label=instr_labels[sc_lbl_idx[4]])
