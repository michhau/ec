...
ax4.hist(ratio1, bins=collect(0:0.01:2), color="black", alpha=0.7, density=true)#, edgecolor="white", linewidth=0.3)
...
ax6.hist(ratio3, bins=collect(-0.5:0.01:1.5), color="black", alpha=0.7, density=true)#, edgecolor="white", linewidth=0.3)
