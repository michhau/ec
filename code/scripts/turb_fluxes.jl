...
ax_m9.hist(ratio_mom1, bins=collect(0.3:0.001:1.8), color="red", alpha=0.7, density=true)
...
ax_m10.hist(ratio_mom2, bins=collect(0.25:0.001:1.6), color="red", alpha=0.7, density=true)
...
ax_m11.hist(ratio_mom3, bins=collect(0.3:0.001:1.6), color="red", alpha=0.7, density=true)
...
ax_m12.hist(ratio_mom4, bins=collect(0.8:0.001:1.5), color="red", alpha=0.7, density=true)
