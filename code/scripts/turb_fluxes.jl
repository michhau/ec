...
ax4.hist(scatter1a, bins=collect(-25:0.1:10), color="grey", alpha=0.5, density=true, label=instr_labels[sc_lbl_idx[1]])
ax4.hist(scatter1b, bins=collect(-25:0.1:10), color="orange", alpha=0.5, density=true, label=instr_labels[sc_lbl_idx[2]])
...
ax5.hist(scatter2a, bins=collect(-5:0.1:5), color="grey", alpha=0.5, density=true, label=instr_labels[sc_lbl_idx[1]])
ax5.hist(scatter2b, bins=collect(-5:0.1:5), color="orange", alpha=0.5, density=true, label=instr_labels[sc_lbl_idx[2]])
...
ax6.hist(scatter3a, bins=collect(-10:0.1:15), color="grey", alpha=0.5, density=true, label=instr_labels[sc_lbl_idx[3]])
ax6.hist(scatter3b, bins=collect(-10:0.1:15), color="orange", alpha=0.5, density=true, label=instr_labels[sc_lbl_idx[4]])
