...
#y-axis limits
wT_limits = (-40, 30)
wq_limits = (-20, 10)#wT_limits

# Upper subplot - Buoyancy fluxes (sensible heat)
ax1.set_title("3b Turbulent Heat Fluxes - Across a ridge")
...
labels = ["lead side 1.1m", "lead side 2.1m", "floe side 1.1m", "floe side 2.1m"]
...
fig.suptitle("3b - 04.08.2025 to 06.08.2025")
...
ax4.hist(scatter1a, bins=collect(-25:0.1:15), color="grey", alpha=0.7, density=true, label="floe~side")
ax4.hist(scatter1b, bins=collect(-25:0.1:15), color="orange", alpha=0.7, density=true, label="lead~side")
...
ax5.hist(scatter2a, bins=collect(-15:0.1:10), color="grey", alpha=0.7, density=true, label="floe~side")
ax5.hist(scatter2b, bins=collect(-15:0.1:10), color="orange", alpha=0.7, density=true, label="lead~side")
...
ax6.hist(scatter3a, bins=collect(-60:0.1:40), color="grey", alpha=0.7, density=true, label="floe~side")
ax6.hist(scatter3b, bins=collect(-60:0.1:40), color="orange", alpha=0.7, density=true, label="lead~side")
...
ax7.hist(ratio1, bins=collect(-5.0:0.01:10.0), color="black", alpha=0.7, density=true)
...
ax9.hist(ratio3, bins=collect(-5.0:0.01:5.0), color="black", alpha=0.7, density=true)
