...
evaldf1 = turb.readturbasnetcdf(joinpath(datapath, "3c_t1_irg_proc_cut.nc"), evalstart, evalend)
evaldf2 = turb.readturbasnetcdf(joinpath(datapath, "3c_t1_csat_proc_cut.nc"), evalstart, evalend)
evaldf3 = turb.readturbasnetcdf(joinpath(datapath, "3c_t2_irg_proc_cut.nc"), evalstart, evalend)
evaldf4 = turb.readturbasnetcdf(joinpath(datapath, "3c_t2_csat_proc_cut.nc"), evalstart, evalend)
...
srf_type = ["lead side", "lead side", "floe side", "floe side"]
heights = [1.1, 2.2, 1.1, 2.2]
