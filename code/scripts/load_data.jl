...
evaldf1 = turb.readturbasnetcdf(joinpath(datapath, "2b_t1_irg_proc_cut.nc"), evalstart, evalend)
evaldf2 = turb.readturbasnetcdf(joinpath(datapath, "2b_t1_csat_proc_cut.nc"), evalstart, evalend)
evaldf3 = turb.readturbasnetcdf(joinpath(datapath, "2b_t2_irg_proc_cut.nc"), evalstart, evalend)
evaldf4 = turb.readturbasnetcdf(joinpath(datapath, "2b_t2_csat_proc_cut.nc"), evalstart, evalend)
